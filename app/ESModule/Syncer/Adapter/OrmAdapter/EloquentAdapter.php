...
{
    public function fetchModelByData(CdcSyncableDto $cdcSyncableDto, string $classNameOrm, mixed $identifierValue): ?Model
    {
        $instance = new $classNameOrm();
        $instance->forceFill($cdcSyncableDto->getData());
