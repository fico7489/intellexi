...
class ModelsRelatedFetcherTest extends TestCase
{
    ...
    public function testOnlyTable()
    {
        ...
        $index = $this->createIndexSyncInterface([
            'test-table' => function ($model, CdcSyncableDto $syncItemDto, array $relatedModels) use ($object) {
                return [$object];
            },
        ]);
    ...
    public function testOnlyModel()
    {
        ...
        $index = $this->createIndexSyncInterface([
            $object::class => function ($model, CdcSyncableDto $syncItemDto, array $relatedModels) use ($object) {
                return [$object];
            },
        ]);
    ...
    public function testCombineTableAndModel()
    {
        ...
        $index = $this->createIndexSyncInterface([
            ...
            $object::class => function ($model, CdcSyncableDto $syncItemDto, array $relatedModels) use ($object2) {
